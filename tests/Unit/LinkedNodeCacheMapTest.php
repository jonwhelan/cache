...
class LinkedNodeCacheMapTest extends \PHPUnit_Framework_TestCase
{
	private $sut;
	private $cache1;
	private $cache2;
	...
	public function setUp()
	{
		...
		$this->sut = new \Whales\Cache\Maps\LinkedNodeCacheMap($this->cache1, $this->cache2);
	}
	...
	public function testReturnsFirstCacheHit()
	{
		$this->cache1->set('key', 'value');
		$this->cache2->set('key', 'anotherValue');
		$this->cache2->set('key2', 'value');
		$this->assertEquals('value', $this->sut->get('key'));
		$this->assertEquals('value', $this->sut->get('key2'));
	}
